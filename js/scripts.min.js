...
$(function(){new fullpage("#fullpage",{lockAnchors:!0,fitToSection:!1,showActiveTooltip:!0,autoScrolling:!0,scrollingSpeed:600,navigation:!0,navigationPosition:"right",navigationTooltips:["Головна","Мої знання","Портфоліо","Мої контакти"],responsiveWidth:400,afterResponsive:function(i){}});$(".owl-carousel").owlCarousel({loop:!0,nav:!0,items:3,dots:!1,smartSpeed:700,responsiveClass:!0,navText:['<i class="fal fa-chevron-left"></i>','<i class="fal fa-chevron-right"></i>'],responsive:{0:{items:1},800:{items:2},1e3:{items:3}}})});