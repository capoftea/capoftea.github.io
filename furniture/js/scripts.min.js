...
/*>>retina*/
 _checkInstance(); }));
$(function(){new fullpage("#fullpage",{navigation:!0,resize:!1,fitToSection:!1,scrollingSpeed:700,autoScrolling:!1,lockAnchors:!0,showActiveTooltip:!0,navigationPosition:"right",navigationTooltips:["Головна","Про нас","Послуги","Як ми працюємо","Портфоліо","Зворотній зв'язок","Контакти"]});var o=document.querySelectorAll(".hamburger");0<o.length&&function(o,t,l){if("[object Object]"===Object.prototype.toString.call(o))for(var e in o)Object.prototype.hasOwnProperty.call(o,e)&&t.call(l,o[e],e,o);else for(var i=0,a=o.length;i<a;i++)t.call(l,o[i],i,o)}(o,function(o){o.addEventListener("click",function(){this.classList.toggle("is-active")},!1)}),$(".hamburger").click(function(){$(".menu").slideToggle()}),$(".owl-carousel-1").owlCarousel({loop:!0,nav:!0,items:1,dots:!0,smartSpeed:700,navText:['<i class="fal fa-chevron-left"></i>','<i class="fal fa-chevron-right"></i>'],responsiveClass:!0}),$(".fotorama2").fotorama({width:1e3,maxwidth:"100%",ratio:16/9,allowfullscreen:!0,nav:"thumbs",thumbheight:100,thumbmargin:20}),$(".up").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")})});