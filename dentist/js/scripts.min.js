...
$(function(){var o;$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),(o=jQuery)(window).on("load",function(){o("#navigation a,a[href='#top'],a[rel='m_PageScroll2id']").mPageScroll2id({highlightSelector:"#navigation a"}),o("a[rel='next']").click(function(t){t.preventDefault();var e=o(this).parent().parent("section").next().attr("id");o.mPageScroll2id("scrollTo",e)})}),$("form").submit(function(){var t=$(this);return $.ajax({type:"POST",url:"mail.php",data:t.serialize()}).done(function(){alert("Thank you!"),setTimeout(function(){t.trigger("reset")},1e3)}),!1}),$(".popup-with-form").magnificPopup({type:"inline",preloader:!1,focus:"#name",callbacks:{beforeOpen:function(){$(window).width()<700?this.st.focus=!1:this.st.focus="#name"}}}),$(".owl-carousel-worker").owlCarousel({loop:!0,nav:!0,items:4,dots:!0,smartSpeed:700,responsiveClass:!0,navText:['<i class="fal fa-chevron-left"></i>','<i class="fal fa-chevron-right"></i>'],responsive:{0:{items:1},400:{items:2},1100:{items:4}}}),$(".hamburger").click(function(){$("#navigation").slideToggle()});var t=document.querySelectorAll(".hamburger");0<t.length&&function(t,e,o){if("[object Object]"===Object.prototype.toString.call(t))for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&e.call(o,t[i],i,t);else for(var a=0,n=t.length;a<n;a++)e.call(o,t[a],a,t)}(t,function(t){t.addEventListener("click",function(){this.classList.toggle("is-active")},!1)})});