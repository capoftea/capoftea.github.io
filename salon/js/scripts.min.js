...
$(function(){var t;$(".owl-carousel-services").owlCarousel({loop:!0,nav:!0,items:4,dots:!0,smartSpeed:700,navText:['<i class="fal fa-chevron-left"></i>','<i class="fal fa-chevron-right"></i>'],responsiveClass:!0,responsive:{0:{items:1},400:{items:2},1100:{items:4}}}),$(".owl-carousel-worker").owlCarousel({loop:!0,nav:!0,items:1,dots:!0,smartSpeed:700,navText:['<i class="fal fa-chevron-left"></i>','<i class="fal fa-chevron-right"></i>'],responsiveClass:!0}),$(".popup-with-form").magnificPopup({type:"inline",preloader:!1,focus:"#name",callbacks:{beforeOpen:function(){$(window).width()<700?this.st.focus=!1:this.st.focus="#name"}}}),$(document).bind("mousewheel",function(e){var o=$(document.body).scrollTop()-e.deltaY*e.deltaFactor*100;e.preventDefault(),e.stopPropagation(),$(document.body).stop().animate({scrollTop:o},500,"easeInOutCubic")}),$(".hamburger").click(function(){$(".top-line").slideToggle()}),(t=jQuery)(window).on("load",function(){t("#top-line a,a[href='#top'],a[rel='m_PageScroll2id']").mPageScroll2id({highlightSelector:"#navigation-menu a"}),t("a[rel='next']").click(function(e){e.preventDefault();var o=t(this).parent().parent("section").next().attr("id");t.mPageScroll2id("scrollTo",o)})});var e=document.querySelectorAll(".hamburger");0<e.length&&function(e,o,t){if("[object Object]"===Object.prototype.toString.call(e))for(var l in e)Object.prototype.hasOwnProperty.call(e,l)&&o.call(t,e[l],l,e);else for(var a=0,i=e.length;a<i;a++)o.call(t,e[a],a,e)}(e,function(e){e.addEventListener("click",function(){this.classList.toggle("is-active")},!1)})});